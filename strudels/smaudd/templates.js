...
const bass2 = note("[a1 a2 ~ [c g1/2]]!2").s("sine,sine")
  // .attack(0.1)
  .dec(0.1)
  .detune(2)
  .fm(sine.range(-1, 8))
...
const lead = note(irand("~ 2 6").rib(0,3).sub("0 7 3.5").seg("16"))
  .scale("E:minor")
  .s("sine,square")
  .phaser(2)
  .dec(0.25)
...
const bk = s("breaks165:0")
  .loopAt(4)
  .room(0.5)
  .dec(0.1)
  .delay(0.125)

const bk2 = s("breaks165:0")
  .loopAt(4)
  .room(0.25)
  .dec(0.05)
  // .delay(0.125)
